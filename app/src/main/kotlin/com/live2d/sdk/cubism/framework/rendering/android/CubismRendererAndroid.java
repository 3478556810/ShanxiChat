...
public class CubismRendererAndroid extends CubismRenderer {
    ...
    public void initialize(CubismModel model, int maskBufferCount) {
        // 頂点情報をキャッシュする。
        drawableInfoCachesHolder = new rendering.android.CubismDrawableInfoCachesHolder(model);
        ...
        if (model.isUsingMasking()) {
            ...
            drawableClippingManager = new rendering.android.CubismClippingManagerAndroid();
        ...
        if (model.isUsingMaskingForOffscreen()) {
            ...
            offscreenClippingManager = new rendering.android.CubismClippingManagerAndroid();
    ...
    rendering.android.CubismDrawableInfoCachesHolder getDrawableInfoCachesHolder() {
     ...
     */
    private final rendering.android.CubismRendererProfileAndroid rendererProfile = new rendering.android.CubismRendererProfileAndroid();
    /**
     * Clipping mask for drawable management object.
     */
    private rendering.android.CubismClippingManagerAndroid drawableClippingManager;
    /**
     * Clipping mask for offscreen management object.
     */
    private rendering.android.CubismClippingManagerAndroid offscreenClippingManager;
    /**
     ...
     * Drawable情報のキャッシュ変数
     */
    private rendering.android.CubismDrawableInfoCachesHolder drawableInfoCachesHolder;
}
